...
class PeriodComparisonController(
    ...
    fun compareWithPreviousPeriod(
        ...
        when (
            val result =
                periodComparisonService.compareWithPreviousPeriod(
                    currentUserProvider.resolve(userDetails),
                    periodType,
                    date,
                    useAi,
