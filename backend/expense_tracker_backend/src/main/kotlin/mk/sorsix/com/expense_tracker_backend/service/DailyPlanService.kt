...
class DailyPlanService(
    ...
    fun getDailyPlanById(planId: Long): DailyPlan? =
        dailyPlanRepository.findByIdOrNull(planId)

    fun createDailyPlan(user: User, planId: Long, request: DailyPlanRequest): CreateDailyPlanResult {
    ...
    fun updateDailyPlan(user: User, dailyPlanId: Long, request: DailyPlanRequest): UpdateDailyPlanResult {
    ...
    fun deleteDailyPlan(user: User, dailyPlanId: Long): DeleteDailyPlanResult {
        val existing = dailyPlanRepository.findById(dailyPlanId).orElse(null)
